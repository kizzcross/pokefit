...
export const workoutsCardioPreviewCreate = <ThrowOnError extends boolean = false>(options: Options<WorkoutsCardioPreviewCreateData, ThrowOnError>) => {
    return (options.client ?? client).post<WorkoutsCardioPreviewCreateResponses, unknown, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                in: 'cookie',
...
export const workoutsCardioReferenceRetrieve = <ThrowOnError extends boolean = false>(options: Options<WorkoutsCardioReferenceRetrieveData, ThrowOnError>) => {
    return (options.client ?? client).get<WorkoutsCardioReferenceRetrieveResponses, unknown, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                in: 'cookie',
...
export const workoutsCardioSessionPartialUpdate = <ThrowOnError extends boolean = false>(options: Options<WorkoutsCardioSessionPartialUpdateData, ThrowOnError>) => {
    return (options.client ?? client).patch<WorkoutsCardioSessionPartialUpdateResponses, unknown, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                in: 'cookie',
...
export const workoutsCardioSessionCreate = <ThrowOnError extends boolean = false>(options: Options<WorkoutsCardioSessionCreateData, ThrowOnError>) => {
    return (options.client ?? client).post<WorkoutsCardioSessionCreateResponses, unknown, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                in: 'cookie',
...
export const workoutsFinishCardioCreate = <ThrowOnError extends boolean = false>(options: Options<WorkoutsFinishCardioCreateData, ThrowOnError>) => {
    return (options.client ?? client).post<WorkoutsFinishCardioCreateResponses, unknown, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                in: 'cookie',
